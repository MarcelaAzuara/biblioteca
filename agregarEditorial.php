...
if (permitirAcceso($_SESSION['tipoUsuario'], 'agregarEditorial')) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="col-md-6">
            ...
            <form action="metodosUsuario.php" name="agregar" method="post">
                ...
                <p>
                    ...
                    <button style="box-shadow: 11px 8px 11px -4px rgba(0,0,0,0.44);-webkit-box-shadow: 11px 8px 11px -4px rgba(0,0,0,0.44);-moz-box-shadow: 11px 8px 11px -4px rgba(0,0,0,0.44);" class="btn btn-danger" onclick="location.href='editorial.php'">Cerrar</button>
                </p>
            </form>
        </div>
    </div>
