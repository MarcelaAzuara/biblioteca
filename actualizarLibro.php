...
if (permitirAcceso($_SESSION['tipoUsuario'], 'actualizarLibro')) {
?>
<!DOCTYPE html>
<html lang="es">
<head>
        ...
        ?>
            ...
            <form action="metodosUsuario.php" name="agregar" method="post">
                ...
                <p>
                    ...
                    <input readonly="readonly" class="btn btn-danger" onclick="location.href='informacionLibro.php'" value="Cerrar">
                </p>
            </form>
